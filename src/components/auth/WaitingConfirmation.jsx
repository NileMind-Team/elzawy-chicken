  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-t-4 border-b-4 border-[#A83232] opacity-30"></div>
      </div>
      ...
      <motion.button
        ...
        className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 text-lg relative overflow-hidden border ${
          resendDisabled
            ...
            : "bg-[#A83232] text-white hover:shadow-xl hover:shadow-[#A83232]/25 border-[#A83232] hover:bg-[#3d0203]"
        }`}
      >
        {resendDisabled
      ...
      <button
        ...
        className="text-[#A83232] hover:text-[#3d0203] underline font-medium transition-colors duration-200 text-sm"
      >
