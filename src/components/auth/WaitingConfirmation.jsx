  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-t-4 border-b-4 border-[#580304] opacity-30"></div>
      </div>
      ...
      <motion.button
        ...
        className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 text-lg relative overflow-hidden border ${
          resendDisabled
            ...
            : "bg-[#580304] text-white hover:shadow-xl hover:shadow-[#580304]/25 border-[#580304] hover:bg-[#3d0203]"
        }`}
      >
        {resendDisabled
      ...
      <button
        ...
        className="text-[#580304] hover:text-[#3d0203] underline font-medium transition-colors duration-200 text-sm"
      >
