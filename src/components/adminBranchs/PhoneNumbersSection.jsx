        ...
        <div className="grid grid-cols-1 gap-2 sm:gap-3">
          <div>
            ...
            <div className="relative group">
              <FaPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#A83232] text-xs" />
              <input
                type="text"
                name="phone"
                value={phoneNumber.phone}
                onChange={handlePhoneInputChange}
                className="w-full border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg pr-9 pl-3 py-2 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-[#A83232] transition-all duration-200 text-sm"
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-[#A83232] transition-all duration-200 text-sm"
              >
                <span className="flex items-center gap-2">
                  <FaPhone className="text-[#A83232] text-xs" />
                ...
                >
                  <FaChevronDown className="text-[#A83232] text-xs" />
                </motion.div>
              </button>
          ...
          <div className="flex items-center justify-center gap-2 py-2">
            ...
            >
              <input
                ...
                className={`w-3 h-3 text-[#A83232] bg-gray-100 border-gray-300 rounded focus:ring-[#A83232] focus:ring-1 ${
                  phoneNumber.type !== "Mobile"
          ...
          <motion.button
            ...
            className={`py-2 rounded-lg font-semibold transition-all duration-300 text-sm flex items-center justify-center gap-2 border-2 ${
              phoneNumber.phone.trim()
                ? "bg-[#A83232] text-white hover:bg-[#3d0203] border-[#A83232]"
          ...
          {phoneNumbers.map((phone, index) => (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                <FaPhone className="text-[#A83232] text-xs sm:text-sm" />
