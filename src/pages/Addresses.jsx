    ...
    <>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 sm:-left-20 -top-10 sm:-top-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#580304]/10 to-[#ffffff]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-10 sm:-right-20 -bottom-10 sm:-bottom-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#ffffff]/10 to-[#580304]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        <motion.button
          ...
          className={`fixed top-3 sm:top-4 left-3 sm:left-4 z-50 ${
            darkMode
              ? "bg-gray-800/80 text-white border-gray-600 hover:bg-[#580304]"
              : "bg-white/80 text-[#580304] border-[#580304] hover:bg-[#580304] hover:text-white"
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    <FaMap className="text-[#580304] text-xl" />
                    <h3
                    ...
                    {!mapLoaded && (
                      <div className="flex items-center justify-center h-64 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-300">
                        <div className="text-center">
                          <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-[#580304] mx-auto mb-4"></div>
                          <p
                            className={`text-sm ${
                              darkMode ? "text-gray-300" : "text-gray-600"
                            }`}
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          ...
                          <motion.button
                            ...
                            className="bg-[#580304] text-white px-6 py-3 rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-200 flex items-center gap-2 whitespace-nowrap flex-shrink-0 border border-white"
                          >
        ...
        >
          <div className="relative h-36 sm:h-40 md:h-44 lg:h-52 bg-[#580304] overflow-hidden border-b border-white">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                  ...
                                  {address.isDefaultLocation && (
                                    <span className="bg-[#580304] text-white text-xs px-2 py-1 rounded-full whitespace-nowrap inline-flex items-center gap-1 self-start sm:self-center border border-white">
                            ...
                            <motion.div
                              ...
                              className={`relative w-6 h-6 sm:w-7 sm:h-7 rounded-full border-2 cursor-pointer transition-all duration-200 flex items-center justify-center ml-2 flex-shrink-0 sm:hidden ${
                                address.isDefaultLocation
                                  ...
                                  : darkMode
                                    ? "border-gray-500 bg-gray-800 hover:border-[#580304] group-hover:border-[#580304]"
                                    : "border-gray-300 bg-white hover:border-[#580304] group-hover:border-[#580304]"
                              }`}
                            >
                              {address.isDefaultLocation && (
                                <motion.div
                    ...
                    >
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <button
                          ...
                          className={`${
                            darkMode
                              ? "text-gray-400 hover:text-[#580304]"
                              : "text-gray-500 hover:text-[#580304]"
                      ...
                      >
                          ...
                          <div className="relative">
                            <button
                              ...
                              className={`w-full flex items-center justify-between border ${
                                darkMode
                                  ? "border-gray-600 bg-gray-800 text-gray-300 hover:border-[#580304]"
                                  : "border-gray-300 bg-white text-gray-600 hover:border-[#580304]"
                              } rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 transition-all group text-sm sm:text-base`}
                            >
                              <div className="flex items-center gap-3">
                                <FaCity className="text-[#580304] text-sm" />
                                <span>
                                  {formData.cityId
                                    ? cities.find(
                                        (c) =>
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            <FaPhone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#580304] text-sm transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="tel"
                              name="phoneNumber"
                              ...
                              } rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#580304] focus:border-transparent transition-all duration-200 text-sm sm:text-base`}
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            <FaRoad className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#580304] text-sm transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="text"
                              name="streetName"
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                          <div>
                            ...
                            <div className="relative group">
                              <FaBuildingIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#580304] text-sm transition-all duration-300 group-focus-within:scale-110" />
                              <input
                                type="text"
                                inputMode="numeric"
                                pattern="[0-9٠-٩]*"
                          ...
                          <div>
                            ...
                            <div className="relative group">
                              <FaTag className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#580304] text-sm transition-all duration-300 group-focus-within:scale-110" />
                              <input
                                type="text"
                                inputMode="numeric"
                                pattern="[0-9٠-٩]*"
                          ...
                          <textarea
                            ...
                            className={`w-full border ${
                              darkMode
                                ? "border-gray-600 bg-gray-800 text-white"
                                : "border-gray-300 bg-white text-black"
                            } rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#580304] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none`}
                        ...
                        <div>
                          ...
                          <motion.button
                            ...
                            className="flex items-center gap-2 w-full mb-2 px-3 py-2.5 bg-[#580304] text-white rounded-lg hover:shadow-lg transition-all duration-200 text-sm font-semibold border border-white"
                          >
                        ...
                        <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            onClick={resetForm}
                            className={`flex-1 py-2.5 sm:py-3 border-2 border-[#580304] text-[#580304] rounded-lg sm:rounded-xl font-semibold hover:bg-[#580304] hover:text-white transition-all duration-300 text-sm sm:text-base`}
                          >
                            إلغاء
                          </motion.button>
                          <motion.button
                            ...
                            className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 border ${
                              isFormValid()
                                ? "bg-[#580304] text-white hover:shadow-xl hover:shadow-[#580304]/25 cursor-pointer border-white"
