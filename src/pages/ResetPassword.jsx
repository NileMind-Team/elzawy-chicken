    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff5f5] to-[#ffe5e5] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 relative font-sans overflow-hidden transition-colors duration-300">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-20 -top-20 w-80 h-80 bg-gradient-to-r from-[#580304]/10 to-[#000000]/10 dark:from-[#580304]/20 dark:to-[#000000]/20 rounded-full blur-3xl"></div>
          <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-gradient-to-r from-[#000000]/10 to-[#580304]/10 dark:from-[#000000]/20 dark:to-[#580304]/20 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="p-8">
            {!loading && message ? (
              <div className="flex flex-col items-center justify-center py-8 space-y-6">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-[#580304] to-[#000000] bg-clip-text text-transparent text-center">
                  {success
                    ? "تم إعادة تعيين كلمة المرور بنجاح"
                    : "فشل إعادة التعيين"}
                </h2>
              ...
              <>
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-[#580304] to-[#000000] bg-clip-text text-transparent">
                ...
                <form onSubmit={handleResetPassword} className="space-y-6">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pl-12 pr-12 py-4 outline-none focus:ring-2 focus:ring-[#580304] focus:border-transparent transition-all duration-200 group-hover:border-[#580304]/50"
                    />
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-600 space-y-2 transition-colors duration-300">
                    <p className="text-sm font-semibold text-[#580304]">
                      متطلبات كلمة المرور:
                    </p>
                  ...
                  <motion.button
                    ...
                    className={`w-full font-semibold py-4 rounded-xl transition-all duration-300 text-lg relative overflow-hidden ${
                      isFormValid
                        ? "bg-[#580304] text-white hover:shadow-xl hover:shadow-[#580304]/25 hover:bg-[#3d0203] border border-[#580304]"
