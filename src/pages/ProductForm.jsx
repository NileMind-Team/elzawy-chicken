...
const ProductForm = () => {
  ...
  */
  ...
  if (isLoadingProduct) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#A83232]/5 via-[#A83232]/10 to-[#A83232]/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700">
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-[#A83232]/5 via-[#A83232]/10 to-[#A83232]/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-2 xs:px-3 sm:px-4 md:px-6 py-2 xs:py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300`}
        dir="rtl"
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-8 xs:-left-10 sm:-left-20 -top-8 xs:-top-10 sm:-top-20 w-32 h-32 xs:w-40 xs:h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#A83232]/10 to-[#A83232]/05 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-8 xs:-right-10 sm:-right-20 -bottom-8 xs:-bottom-10 sm:-bottom-20 w-32 h-32 xs:w-40 xs:h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#A83232]/05 to-[#A83232]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        >
          <div className="relative h-28 xs:h-32 sm:h-40 md:h-44 lg:h-52 bg-[#A83232] overflow-hidden">
            ...
            <motion.button
              ...
              onClick={() => navigate(-1)}
              className="absolute top-2 xs:top-3 sm:top-6 left-2 xs:left-3 sm:left-6 z-50 bg-white/80 backdrop-blur-md hover:bg-[#A83232] hover:text-white rounded-full p-1.5 xs:p-2 sm:p-3 text-[#A83232] border border-[#A83232] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#A83232]"
            >
              <FaArrowLeft
                size={12}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                    <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                ...
                                <motion.button
                                  ...
                                  className={`flex flex-col items-center gap-1 xs:gap-1.5 sm:gap-2 p-1.5 xs:p-2 sm:p-3 rounded-lg border-2 transition-all duration-200 ${
                                    formData.CategoryId === category.id
                                      ? "border-[#A83232] bg-white text-[#A83232] dark:bg-gray-600"
                          ...
                          <div className="grid grid-cols-2 gap-2 xs:gap-3 mb-3">
                            <motion.button
                              ...
                              className={`flex items-center justify-center gap-1.5 xs:gap-2 p-2 xs:p-3 rounded-lg border-2 transition-all duration-200 ${
                                !formData.IsPriceBasedOnRequest
                                  ? "border-[#A83232] bg-white text-[#A83232] shadow-md dark:bg-gray-600"
                                  : "border-gray-300 bg-white text-gray-600 hover:border-gray-400 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300 dark:hover:border-gray-400"
                              }`}
                            >
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <FaFire className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#A83232] text-sm transition-all duration-300 group-focus-within:scale-110" />
                          <input
                            type="number"
                            name="Calories"
                            ...
                            min="0"
                            onWheel={(e) => e.target.blur()}
                            className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white pr-10"
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 xs:gap-3">
                          <div className="relative group">
                            <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#A83232] text-xs transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="number"
                              ...
                              min="0"
                              onWheel={(e) => e.target.blur()}
                              className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white pr-8"
                              placeholder="من"
                            />
                          </div>
                          <div className="relative group">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 bg-gray-50/80 dark:bg-gray-600/80 rounded-lg p-2 xs:p-3 border border-gray-300 dark:border-gray-500">
                          <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer p-2 xs:p-3 rounded-lg transition-all duration-200 border-2 border-transparent hover:border-[#A83232]/30">
                        ...
                        <div className="flex gap-3 bg-gray-50/80 dark:bg-gray-600/80 rounded-lg p-2 xs:p-3 border border-gray-300 dark:border-gray-500">
                          <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer p-2 xs:p-3 rounded-lg transition-all duration-200 border-2 border-transparent hover:border-[#A83232]/30">
                            ...
                            <div className="flex items-center gap-1.5">
                              <FaSlidersH className="text-[#A83232] text-xs xs:text-sm" />
                              <span className="text-xs xs:text-sm font-medium text-gray-700 dark:text-gray-300">
                                عرض
                              </span>
                            </div>
                    ...
                    <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                      <div>
                        ...
                        {imageInputMode === "upload" ? (
                          <div
                            className="border-2 border-dashed border-gray-300 rounded-lg p-2 xs:p-3 sm:p-4 text-center hover:border-[#A83232] transition-colors duration-200 cursor-pointer dark:border-gray-600"
                              ...
                              <div className="mb-3 xs:mb-4">
                                ...
                                <div className="flex gap-2">
                                  <input
                                    ...
                                    className="flex-1 border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                  />
                                  <motion.button
                                    type="button"
                                    whileHover={{ scale: 1.02 }}
                                    ...
                                    className={`px-3 xs:px-4 py-2 xs:py-2.5 rounded-lg font-semibold transition-all duration-300 flex items-center gap-1.5 xs:gap-2 text-xs xs:text-sm ${
                                      imageUrl.trim() && !isDownloadingImage
                                        ? "bg-[#A83232] text-white hover:shadow-xl hover:shadow-[#A83232]/25 cursor-pointer"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          rows="3"
                          className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#A83232] focus:border-transparent transition-all duration-200 resize-none text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                ...
                */}
                  ...
                  <div className="flex gap-2 xs:gap-3 sm:gap-4 pt-3 xs:pt-4 sm:pt-6 border-t border-gray-300 dark:border-gray-600">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => navigate("/")}
                      className="flex-1 py-2 xs:py-2.5 sm:py-3 border-2 border-[#A83232] text-[#A83232] rounded-lg font-semibold hover:bg-[#A83232] hover:text-white transition-all duration-300 text-xs xs:text-sm sm:text-base flex items-center justify-center gap-1.5 xs:gap-2 dark:border-[#A83232] dark:text-[#A83232] dark:hover:bg-[#A83232] dark:hover:text-white"
                    >
            ...
            <>
              ...
              >
                <div
                  ...
                  dir="rtl"
                >
                  <div className="bg-[#A83232] text-white p-4 sm:p-6 relative border-b border-white">
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 transition-colors duration-300 shadow-lg">
                      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                        <div className="bg-[#A83232]/10 p-2 rounded-xl border border-[#A83232]/20">
                          <FaPlus className="text-[#A83232] text-base sm:text-lg" />
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#A83232] focus:border-[#A83232] outline-none transition-all text-right text-base sm:text-lg font-medium"
                            />
                          </div>
                        </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                        <div className="bg-[#A83232]/10 p-2 rounded-xl border border-[#A83232]/20">
                          <FaList className="text-[#A83232] text-base sm:text-lg" />
                        </div>
                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-200">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        {optionTypes.map((optionType) => (
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            className="bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 hover:border-[#A83232]/30 dark:hover:border-[#A83232]/30 rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-lg group"
                          >
                            {editingOptionType &&
                              ...
                              <div className="space-y-4 sm:space-y-6">
                                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                                  <div>
                                    ...
                                    <input
                                      ...
                                      className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#A83232] focus:border-[#A83232] outline-none transition-all text-right text-base sm:text-lg font-medium"
                                      dir="rtl"
                                    />
                                  </div>
                                </div>
                                ...
                                <div className="flex gap-2 sm:gap-3 justify-start pt-3 sm:pt-4 border-t border-gray-300 dark:border-gray-600">
                                  ...
                                  <motion.button
                                    ...
                                    className="bg-[#A83232] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold hover:shadow-lg transition-all flex items-center gap-2 text-sm sm:text-base shadow-lg border border-[#A83232] hover:bg-[#3d0203]"
                                  >
                                    <FaSave />
                                    حفظ التغييرات
                                  </motion.button>
