...
export default function Reviews() {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#580304]/5 to-[#580304]/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300`}
      >
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#580304] hover:text-white rounded-full p-2 sm:p-3 text-[#580304] border border-[#580304] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#580304]"
        >
          <FaArrowLeft
            size={14}
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                            <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] border border-gray-300 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                              <FaStore className="text-[#580304] text-xs sm:text-sm" />
                            </div>
                ...
                {reviews.length === 0 && !isAdding && (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={handleAddNewReview}
                      className="flex items-center gap-2 bg-[#580304] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base mx-auto border border-white hover:bg-[#3d0203]"
                    >
                  ...
                  >
                    <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200 shadow-lg sticky top-4 sm:top-6 dark:bg-gray-700/80 dark:border-gray-600">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <button
                          onClick={resetForm}
                          className="text-gray-500 hover:text-[#580304] transition-colors duration-200 flex-shrink-0 ml-2 dark:text-gray-400 border border-gray-300 p-1 rounded-full"
                        >
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="w-full flex items-center justify-between border border-gray-300 bg-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 text-gray-600 hover:border-[#580304] transition-all group text-sm sm:text-base dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300"
                            >
                              <div className="flex items-center gap-3">
                                <FaStore className="text-[#580304] text-sm" />
                                <span>
                                  {formData.branchId
                                    ? branches.find(
                                        (b) =>
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-between gap-2 bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] p-2 sm:p-3 rounded-lg sm:rounded-xl border border-gray-300 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                            <div className="flex items-center gap-2 flex-shrink-0">
                              <FaStar className="text-[#580304] text-xs sm:text-sm" />
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs sm:text-sm font-semibold text-[#580304] whitespace-nowrap">
                                ({formData.rating}/5)
                              </span>
                            </div>
                          </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            required
                            rows="4"
                            className="w-full border border-gray-300 bg-white text-black rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#580304] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                        ...
                        <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            onClick={resetForm}
                            className="flex-1 py-2.5 sm:py-3 border-2 border-[#580304] text-[#580304] rounded-lg sm:rounded-xl font-semibold hover:bg-[#580304] hover:text-white transition-all duration-300 text-sm sm:text-base dark:border-[#580304] dark:text-[#580304] dark:hover:bg-[#580304] dark:hover:text-white"
                          >
                            إلغاء
                          </motion.button>
                          <motion.button
                            ...
                            className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 border ${
                              isFormValid()
                                ? "bg-[#580304] text-white hover:shadow-xl hover:shadow-[#580304]/25 cursor-pointer border-white hover:bg-[#3d0203]"
