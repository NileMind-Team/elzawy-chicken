...
const Home = () => {
  ...
  const showNotification = (type, title, text, options = {}) => {
    if (options.showConfirmButton || options.showCancelButton) {
      Swal.fire({
        ...
        confirmButtonColor: "#580304", // Updated: Dark red primary color
    ...
    if (product.itemOffer && product.itemOffer.isEnabled) {
      return (
        <>
          ...
          <div className="text-[#580304] font-bold text-sm">
            {product.finalPrice.toFixed(2)} ج.م
          </div>
        </>
      );
  ...
  return (
    <>
              ...
              >
                {modalLoading ? (
                  <div className="flex items-center justify-center py-8 sm:py-12">
                    <div className="animate-spin rounded-full h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 border-t-4 border-b-4 border-[#580304]"></div>
                  </div>
                                  ...
                                  <div key={option.id} className="w-full">
                                    ...
                                    >
                                      <div className="flex items-center gap-1 sm:gap-2 truncate min-w-0">
                                        ...
                                        {isSelected && (
                                          <FaCheck className="text-[#580304] flex-shrink-0 w-3 h-3 sm:w-4 sm:h-4" />
                                        )}
                                      </div>
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 sm:py-3 rounded-lg font-semibold flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base ${
                          addingToCart === selectedProductForAddons?.id
                            ...
                            : "bg-[#580304] text-white hover:bg-[#3d0203] border border-[#580304]"
                        }`}
                      >
                        {addingToCart === selectedProductForAddons?.id ? (
                          <>
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[#580304] text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#580304]/5 via-[#580304]/10 to-[#580304]/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 font-sans relative overflow-x-hidden">
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-3 md:p-4 relative w-full border border-gray-200">
            <button
              ...
              className="absolute left-1 md:left-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#580304] z-10 shadow-lg border border-gray-300"
            >
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`flex-shrink-0 flex items-center gap-2 px-3 md:px-4 py-2 md:py-3 rounded-xl font-semibold text-sm md:text-base transition-all duration-300 ${
                    selectedCategory === category.id
                      ? "bg-[#580304] text-white shadow-lg border-2 border-[#580304]"
                ...
                >
                  ...
                  {category.id !== "all" &&
                    category.id !== "offers" &&
                    !category.isActive && (
                      <span className="text-xs text-[#580304]">(معطل)</span>
                    )}
                </button>
              ))}
            </div>
            ...
            <button
              ...
              className="absolute right-1 md:right-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#580304] z-10 shadow-lg border border-gray-300"
            >
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 md:py-6 w-full">
              <div className="text-center py-12 md:py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-lg mx-2 border border-gray-200">
                ...
                <button
                  ...
                  className="bg-[#580304] text-white px-6 py-3 rounded-xl font-semibold shadow-lg text-sm md:text-base hover:bg-[#3d0203] transition-colors border border-[#580304]"
                >
                  عرض جميع المنتجات
                </button>
              </div>
                  ...
                  >
                    {product.itemOffer && product.itemOffer.isEnabled && (
                      <div className="absolute top-2 right-2 z-10">
                        <div className="bg-[#580304] text-white px-3 py-1.5 rounded-xl shadow-2xl flex items-center gap-1.5 border border-white">
                    ...
                    <div className="sm:hidden">
                      <div className="p-3">
                        <div className="flex">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="font-bold text-sm text-gray-800 dark:text-gray-200 hover:text-[#580304] line-clamp-1 mb-2"
                          ...
                          <button
                            ...
                            className={`flex-1 py-2.5 rounded-xl font-semibold flex items-center justify-center gap-2 text-xs no-product-details ${
                              addingToCart === product.id
                                ...
                                : isProductAvailableForCart(product)
                                  ? "bg-[#580304] text-white hover:bg-[#3d0203]"
                          ...
                          <button
                            ...
                            className={`p-2.5 rounded-xl font-semibold flex items-center justify-center text-xs no-product-details border ${
                              isProductInFavorites(product.id)
                                ? "text-[#580304] bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 border-[#580304]"
                                : "text-gray-400 bg-gray-50 dark:bg-gray-700 hover:text-[#580304] hover:bg-gray-100 dark:hover:bg-gray-600 border-gray-300"
                            }`}
                          >
                            {isProductInFavorites(product.id) ? (
                              <FaHeart size={16} />
                    ...
                    <div className="hidden sm:block">
                      ...
                      <div className="p-3 sm:p-4">
                        <h3
                          className="font-bold text-base sm:text-lg text-gray-800 dark:text-gray-200 mb-2 hover:text-[#580304] line-clamp-1"
                          dir={isArabic(product.name) ? "rtl" : "ltr"}
                        >
                          {product.name}
                        </h3>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <button
                            ...
                            className={`p-2 rounded-full no-product-details border ${
                              isProductInFavorites(product.id)
                                ? "text-[#580304] bg-red-50 dark:bg-red-900/20 border-[#580304]"
                                : "text-gray-400 bg-gray-50 dark:bg-gray-700 hover:text-[#580304] border-gray-300"
                            }`}
                          >
                            {isProductInFavorites(product.id) ? (
                              <FaHeart size={18} />
        ...
        {/* Cart Button */}
        <div
          className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-[#580304] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 no-product-details border-2 border-white ${
        ...
        <div className="fixed bottom-4 left-4 flex flex-col gap-3 z-40">
          ...
          <button
            ...
            className="relative bg-[#580304] text-white rounded-full p-3 sm:p-4 shadow-2xl hover:scale-110 no-product-details border-2 border-white"
          >
            <div className="relative flex items-center justify-center">
              <FaHeart className="w-4 h-4 sm:w-6 sm:h-6" />

              {favorites.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-white text-[#580304] rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-xs font-bold shadow-md border border-[#580304]">
                  {favorites.length}
                </span>
              )}
            </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 shadow-lg">
                      ...
                      <div className="lg:col-span-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#580304] focus:border-[#580304] outline-none text-right text-base font-medium"
                          />
                        </div>
                      </div>
                    ...
                    <div className="flex justify-start mt-4 sm:mt-6">
                      <button
                        ...
                        className="bg-[#580304] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold shadow-lg flex items-center gap-2 sm:gap-3 text-sm sm:text-base no-product-details hover:bg-[#3d0203] border border-[#580304]"
                      >
                        <FaPlus />
                        إضافة تصنيف جديد
                      </button>
                        ...
                        <div
                          ...
                          className={`bg-white dark:bg-gray-700 border-2 ${
                            category.id === "all" || category.id === "offers"
                              ...
                              : "border-gray-200 dark:border-gray-600 hover:border-[#580304]/50 dark:hover:border-[#580304]/50"
                            ...
                            <div className="space-y-4 sm:space-y-6">
                              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                                <div className="lg:col-span-2">
                                  ...
                                  <input
                                    ...
                                    className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#580304] focus:border-[#580304] outline-none text-right text-base font-medium"
                                    dir="rtl"
                                  />
                                </div>
                              ...
                              <div className="flex gap-2 sm:gap-3 justify-start pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-600">
                                ...
                                <button
                                  ...
                                  className="bg-[#580304] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold shadow-lg flex items-center gap-2 text-sm sm:text-base no-product-details hover:bg-[#3d0203] border border-[#580304]"
                                >
                                  <FaSave />
                                  حفظ التغييرات
                                </button>
