              ...
              <div className="flex items-start gap-4 p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="inline-block text-[#A83232] hover:text-[#3d0203] font-bold text-xl transition-colors bg-red-50 dark:bg-red-900/20 px-6 py-3 rounded-lg"
                  >
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="font-bold text-[#A83232]">Subject:</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="font-bold text-[#A83232]">Message:</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-lg">
                      ...
                      <span className="font-bold text-[#A83232]">48 hours</span>
                      .
                    </p>
                  </div>
                </div>
