                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              ...
                              <div className="text-center col-span-2">
                                ...
                                <p className="text-lg font-bold text-[#A83232]">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-[#A83232]">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <FaCalendarAlt className="text-[#A83232] text-xl" />
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2.5 border ${
                          isBranchDropdownOpen
                            ? "border-[#A83232] ring-2 ring-[#A83232]/30"
                            : "border-gray-300 dark:border-gray-600"
                        } dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#A83232] focus:border-transparent outline-none text-right group transition-all`}
                      >
                        <div className="flex items-center gap-2">
                          <FaBuilding className="text-[#A83232]" />
                          <span className="text-sm">
                            {getSelectedBranchName()}
                          </span>
                        </div>
                        <FaChevronDown
                          className={`text-[#A83232] transition-transform duration-300 ${
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                          {reportData.map((order, index) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-center font-bold text-[#A83232]">
